$(document).ready(function() {
    ...
    $('#id_select_group').on('change', function() { // Id of groups.php's form
        ...
        if(groupId != -1) {
            ...
            handleGroupChange(activities, groupId, uncheckAllButton, checkboxCounter);
                    ...
                    success: function(message) {
                        ...
                        activityItems.forEach(function(item) {
                            ...
                            if (checkbox.checked) {
                                ...
                                $.ajax({
                                    url: 'ajax/update_group_date.php',
                                    type: 'POST',
                                    data: { activityId: activityId, startTimestampInSeconds: startTimestampInSeconds, endTimestampInSeconds : endTimestampInSeconds, groupId: groupId },
                                    success: function(message) {
                                        ...
                                        // Refresh dates
                                        refreshGroupDates(activities, groupId);
